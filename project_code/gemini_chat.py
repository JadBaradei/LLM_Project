...
from tools import search_vector_db, search_google_scholar, plot_excel_sheet
...
class GeminiChat:
    def __init__(self, model_name: str = "gemini-pro", temperature: float = 0.0):
        ...
        self.agent = create_react_agent(self.llm, tools=[search_vector_db, search_google_scholar, plot_excel_sheet])
